...
- **`pareto.py`**: `fit_pure_pareto(...)` → `ParetoResult`, solved with pymoo NSGA-II (derivative-free — large regions of parameter space have no VLE at all, handled by returning `_BIG`).
