...
1-octanol + water LLE data, and saves the best result (lowest ARD) to JSON.
...
# PC-SAFT parameters for 1-octanol (Gross & Sadowski, Ind. Eng. Chem. Res. 2001)
